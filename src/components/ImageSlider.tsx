...
const ScrollAreaHorizontalDemo = () => {
  ...
  return (
    ...
    <ScrollArea className="w-full xl:max-w-7xl flex justify-center items-center lg:max-w-5xl md:max-w-3xl sm:max-w-2xl max-sm:max-w-[360px] h-[60vh] max-sm:h-[50vh]  bg-gray-100 dark:bg-gray-700  rounded-lg shadow-lg overflow-x-auto p-4">
